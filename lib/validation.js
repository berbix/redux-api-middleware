...
function isPlainObject(obj) {
  return obj && (0, _typeof2.default)(obj) == 'object' && Object.getPrototypeOf(obj) === Object.prototype;
}
/**
...
function isRSAA(action) {
  return isPlainObject(action) && action.hasOwnProperty(_RSAA.default);
}
/**
...
function isValidTypeDescriptor(obj) {
  ...
  if (!('type' in obj)) {
    return false;
  } else if (typeof obj.type !== 'string' && (0, _typeof2.default)(obj.type) !== 'symbol') {
    return false;
  }
...
function validateRSAA(action) {
  ...
  var callAPI = action[_RSAA.default];
  ...
  if (typeof types === 'undefined') {
    ...
    if (typeof requestType !== 'string' && (0, _typeof2.default)(requestType) !== 'symbol' && !isValidTypeDescriptor(requestType)) {
      validationErrors.push('Invalid request type');
    }

    if (typeof successType !== 'string' && (0, _typeof2.default)(successType) !== 'symbol' && !isValidTypeDescriptor(successType)) {
      validationErrors.push('Invalid success type');
    }

    if (typeof failureType !== 'string' && (0, _typeof2.default)(failureType) !== 'symbol' && !isValidTypeDescriptor(failureType)) {
